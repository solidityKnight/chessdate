    ...
    <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-pink-100 p-10 relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <div className="flex flex-col items-center mb-10">
          ...
          <h2 className="text-3xl font-black text-gray-900 tracking-tight text-center">Send us a <span className="text-pink-500 italic">Love Note</span></h2>
          <p className="text-gray-400 text-sm mt-2 font-medium italic text-center">We'll get back to you faster than a scholar's mate.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-pink-600 uppercase tracking-[0.2em] ml-2">Your Name</label>
              <input 
                type="text" 
                required
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-pink-600 uppercase tracking-[0.2em] ml-2">Email Address</label>
              <input 
                type="email" 
                required
                className="w-full p-4 rounded-2xl bg-pink-50/30 border-2 border-transparent focus:border-pink-500 focus:bg-white focus:ring-8 focus:ring-pink-500/5 outline-none transition-all font-bold text-gray-800 placeholder:text-gray-300 placeholder:font-medium"
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-pink-600 uppercase tracking-[0.2em] ml-2">Subject</label>
            <input 
              type="text" 
              required
              className="w-full p-4 rounded-2xl bg-pink-50/30 border-2 border-transparent focus:border-pink-500 focus:bg-white focus:ring-8 focus:ring-pink-500/5 outline-none transition-all font-bold text-gray-800 placeholder:text-gray-300 placeholder:font-medium"
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-pink-600 uppercase tracking-[0.2em] ml-2">Message</label>
            <textarea 
              required
              rows={5}
