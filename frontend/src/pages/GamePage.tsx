...
const GamePage: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 p-2 sm:p-4 overflow-hidden flex flex-col">
      <div className="max-w-7xl mx-auto w-full h-full flex flex-col min-h-0">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6 flex-1 min-h-0">
          ...
          <div className="lg:col-span-2 flex justify-center items-center min-h-0 h-full">
            <div className="bg-gray-800 rounded-lg p-2 sm:p-4 border border-gray-700 w-full lg:w-auto flex flex-col items-center max-h-full min-h-0 overflow-hidden shadow-2xl">
              <div className="flex justify-center mb-1 sm:mb-2 shrink-0">
                <MatchStatus />
              </div>
              <div className="flex justify-center flex-1 min-h-0 w-full overflow-hidden">
        ...
        {/* Game Info Footer */}
        <div className="mt-2 text-center text-gray-500 text-[9px] sm:text-[10px] shrink-0 opacity-40">
